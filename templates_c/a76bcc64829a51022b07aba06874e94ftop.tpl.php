...
<p>
	你好, <strong><?php echo $this->_vars['level_name'];?></strong> [ <?php echo $this->_vars['admin_user'];?> ] <a href="../index.php" target="_black">[去首页]</a> [<a href="admin_login.php?action=logout" target="_parent">退出</a>]
</p>
