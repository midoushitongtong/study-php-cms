...
<div class="main">
	...
	<table>
		...
		<tr>
			...
			<td><a href="permission.php?action=update&id=<?php echo $value->id?>">修改</a> | <a href="permission.php?action=delete&id=<?php echo $value->id?>" onclick="return confirm('你确定删除吗') ? true : false">删除</a></td>
		</tr>
		<?php } ?>
		<?php } else { ?>
