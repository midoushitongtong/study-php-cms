...
<div id="header">
	<h1><a href="javascript:;"><?php echo $this->_vars['webname'];?></a></h1>
...
<div id="search">
	...
	<ul>
		...
		<li><a href="search.php?type=3&inputkeyword=<?php echo $value->tagname?>" style="color: #06f;"><?php echo $value->tagname?>(<?php echo $value->count?>)</a></li>
		<?php } ?>
		<?php } ?>
	</ul>
</div>